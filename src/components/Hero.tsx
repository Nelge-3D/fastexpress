            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
              {trustBadges.map((badge, i) => (
                <motion.div
                  ...
                  initial="hidden"
                  animate="visible"
                  className="bg-white/10 backdrop-blur border border-white/20 rounded-xl p-3 text-center group hover:bg-white/15 transition-all duration-300"
                >
                  <badge.icon className="w-5 h-5 text-[#f5a623] mx-auto mb-2 group-hover:scale-110 transition-transform duration-300" />
